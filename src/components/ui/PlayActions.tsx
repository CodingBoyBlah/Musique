...
export function PlayActions({ tracks, contextId, pinItem }: Props) {
  ...
  // when the button row gets narrow (lyrics/queue panel open on a small window)
  // collapse Play and Shuffle to icononly so all four buttons stay on ONE tidy row
  // instead of wrapping into a misaligned mess
  ...
  return (
    <div ref={rootRef} className="flex items-center mt-3" style={{ gap: 12, flexWrap: "wrap", rowGap: 12 }}>
      <motion.button
        layout
        onClick={onPlay}
        disabled={empty}
        ...
        style={{
          ...
          gap: compact ? 0 : 8, height: 44,
          minWidth: 44, padding: compact ? 0 : "0 24px",
      ...
      <motion.button
        ...
        style={{
          ...
          display: "flex", alignItems: "center", justifyContent: "center",
          gap: compact ? 0 : 8, height: 44,
          minWidth: 44, padding: compact ? 0 : "0 18px",
          borderRadius: 99,
