  ...
  return (
    <section>
      ...
      {isLoading ? (
        ...
        <TrackTiles tracks={data.slice(0, 12)} context="recently-played" />
      )}
    </section>
  );
}
...
function TopTracks() {
  ...
  return (
    <section>
      <SectionTitle right={<RangeToggle value={range} onChange={setRange} />}>
        Your top tracks
      </SectionTitle>
      {isLoading ? (
        <TileSkeleton />
...
export default function Home() {
  ...
  return (
    ...
    >
      ...
      {/* quick access grid - auto-fill so tiles stretch to fill the row evenly
      ...
      <div
        style={{
          ...
          gridTemplateColumns:
            "repeat(auto-fill, minmax(clamp(150px, 18vw, 200px), 1fr))",
        }}
      >
